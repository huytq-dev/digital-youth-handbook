  ...
  return (
    <nav
      className={cn(
        ...
        scrolled
          ? "bg-white/70 py-3 shadow-sm backdrop-blur-xl border-[hsl(var(--border))]"
          : "bg-transparent py-5"
      )}
    >
      <div className="mx-auto flex h-12 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        {/* Desktop Navigation (kèm menu con giống landing-header) */}
              ...
              <div className="flex flex-col py-1 text-sm">
                ...
                >
                  <Sparkles
                    ...
                    className="text-[hsl(var(--muted-foreground))]"
                  />
                  <AnimatedText>Kế hoạch đã lưu</AnimatedText>
                </button>
                <button
                  type="button"
